...
export function Feed({ onLogout }: { onLogout: () => void }) {
  ...
  const settingsHasBadge = (billingBadgeInfo?.showWarning ?? false) || usagePercent >= 80;
  ...
  return (
    <div className="feed-v2-container">
      ...
      <nav className="feed-tab-bar">
        ...
        >
          <span className="feed-tab-icon-wrap">
            <svg className="feed-tab-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            {settingsHasBadge && <span className="feed-tab-badge-dot" />}
          </span>
